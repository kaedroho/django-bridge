...
Django Bridge is a Python and TypeScript package for building React frontends for Django applications. It lets you use Django URL patterns and views to build single page apps.
...
Like a regular Django app, all requests are routed by URL patterns defined in Python to a Django view. Views return JSON instead of HTML to describe what to render and the rendering is done by React instead of a template.
